...
### Giao diện mới & Đăng nhập bằng Google
Tên ngắn: Giao diện mới tăng trải nghiệm người dùng
Nhãn: BẢN CẬP NHẬT LỚN
...
- **Không mất quyền truy cập tài khoản:** Sau khi liên kết Google, mật khẩu cũ của bạn vẫn dùng được. Mất quyền truy cập Gmail thì vẫn đăng nhập bằng mật khẩu như thường, và ngược lại.
