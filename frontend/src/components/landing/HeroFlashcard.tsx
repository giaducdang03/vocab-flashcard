      ...
      <div className="relative flex flex-col gap-3">
        <div className="flex items-center justify-between px-1">
          <div className="flex items-center gap-2">
            <span className="text-caption-uppercase text-muted">DECK:</span>
          ...
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center gap-1 rounded-full border border-secondary/20 bg-learned-surface px-2.5 py-0.5 font-mono text-[12px] text-secondary">
              <CheckCircle2 size={14} /> 94% Retention
            </span>
        ...
        <div
          ...
          role="button"
          tabIndex={0}
          aria-label={flipped ? 'Flip card to the word' : 'Flip card to the meaning'}
        ...
        >
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-hairline-soft pb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="whitespace-nowrap font-mono text-code-sm text-muted">CEFR C1 · ACADEMIC</span>
            </div>
            <div className="flex items-center gap-2">
              <button
                type="button"
              ...
              >
                ...
                />
                <span>{flipped ? 'Flip to Word' : 'Flip to Meaning'}</span>
              </button>
            </div>
          </div>
          ...
          <div className="my-6">
            {flipped ? (
              ...
              <div className="flex flex-col items-center space-y-3 py-4 text-center">
                ...
                <div className="flex items-center gap-2 font-mono text-code-phonetic text-muted">
                  ...
                  <span className="font-sans text-body-sm text-muted">UK / US</span>
                </div>
            ...
            <div className="mt-4 rounded-xl border border-hairline bg-canvas-soft p-4 text-left">
              <div className="mb-1 flex items-center gap-1.5 text-primary">
                <BookOpen size={16} />
                <span className="text-caption-uppercase font-semibold">IELTS Contextual Collocation</span>
              </div>
          ...
          <div className="border-t border-hairline-soft pt-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div className="flex flex-wrap items-center gap-1.5">
                <span className="mr-1 text-caption-uppercase text-muted">SYNONYMS:</span>
                {SYNONYMS.map((word) => (
                  <span
                    key={word}
              ...
              <span className="font-mono text-code-sm text-muted">Card 14 of 46</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 px-2 pt-1">
          <div className="flex items-center gap-2">
            ...
            >
              <Keyboard size={16} /> [Space] Flip
            </button>
            <button
              type="button"
              className="inline-flex items-center gap-1 rounded-lg border border-hairline bg-surface-card px-3 py-1.5 font-mono text-code-sm text-ink transition-colors hover:bg-surface-container"
            >
              <MoveRight size={16} /> [→] Next
            </button>
          </div>
          <div className="flex items-center gap-1 text-body-sm text-muted">
            <span className="h-2 w-2 rounded-full bg-secondary" />
            <span>Spaced Repetition: Leitner Box 4</span>
          </div>
        </div>
      </div>
    </div>
