          ...
          {step === 2 && (
            <div className="grid gap-4">
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ fontWeight: 500 }}>
                          ...
                          {AI_QUESTION_TYPES.includes(type) && (
                            <span className="type-chip">AI</span>
                          )}
                        </div>
                      </div>
              ...
              {types.some((type) => AI_QUESTION_TYPES.includes(type)) && (
                <p className="ai-note">
                  Đề sẽ được AI soạn trong nền và mất khoảng 10–40 giây. Bạn có thể
                  đóng cửa sổ này, đề sẽ tự hiện trong danh sách khi xong.
                </p>
              )}
            </div>
          )}
